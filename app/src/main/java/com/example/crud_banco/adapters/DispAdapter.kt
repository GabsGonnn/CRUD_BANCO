...
class DispAdapter (private val dispList: ArrayList<DispositivosModelo>) :
    RecyclerView.Adapter<DispAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvDispName.text = currentDisp.dispNome
    }
